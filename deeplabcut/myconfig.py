...
analysis_opts = [
    cfg.StrOpt(
        ...
        help="Base directory for videos to analyze."
    ),
    cfg.StrOpt(
        "video-type",
        default=".avi",
        help="Type of videos to analyze"
    ),
    cfg.IntOpt(
        "trainings-iterations",
        default=500,
        help="type the number listed in the h5 file containing the pose estimation data. The video will be generated"
    ),
    cfg.FloatOpt(
        "trainings-fraction",
        default=0.95,
